...
$query = mysql_query("update dataperusahaan set emailperusahaan='$emailperusahaan', namaperusahaan='$namaperusahaan', noteleponperusahaan='$noteleponperusahaan', alamatperusahaan='$alamatperusahaan', deskripsiperusahaan='$deskripsiperusahaan', jenispekerjaanyangadadiperusahaan='$jenispekerjaanyangadadiperusahaan' where perusahaan_id='$id'") or die(mysql_error());
