                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $query = mysql_query("select * from dataperusahaan,datalowongan where dataperusahaan.perusahaan_id=datalowongan.perusahaan_id and usernameperusahaan='$usernameperusahaan'");
                                    $no = 1;
