...
<tr>
            <td>Username</td>
            <td>:</td>
            <td><input type="text" name="usernameperusahaan" maxlength="20" required="required" value="<?php echo $data['usernameperusahaan']; ?>" disabled /></td>
        </tr>
        <tr>
            <td>Nama Perusahaan</td>
            <td>:</td>
            <td><input type="text" name="namaperusahaan" required="required" value="<?php echo $data['namaperusahaan']; ?>" /></td>
        </tr>
        <tr>
            <td>Email Perusahaan</td>
            <td>:</td>
            <td><input type="email" name="emailperusahaan" maxlength="100" required="required" value="<?php echo $data['emailperusahaan']; ?>" /></td>
        </tr>
        <tr>
            <td>No Telepon Perusahaan</td>
            <td>:</td>
            <td><input type="text" name="noteleponperusahaan" maxlength="13" required="required" value="<?php echo $data['noteleponperusahaan']; ?>" /></td>
        </tr>
        <tr>
            <td>Alamat Perusahaan</td>
            <td>:</td>
            <td><input type="text" name="alamatperusahaan" required="required" value="<?php echo $data['alamatperusahaan']; ?>" /></td>
        </tr>
        <tr>
            <td>Deskripsi Perusahaan</td>
            <td>:</td>
            <td><input type="text" name="deskripsiperusahaan" required="required" value="<?php echo $data['deskripsiperusahaan']; ?>" /></td>
        </tr>
        <tr>
            <td>Jenis Pekerjaan yang ada di perusahaan</td>
            <td>:</td>
            <td><input type="text" name="jenispekerjaanyangadadiperusahaan" required="required" value="<?php echo $data['jenispekerjaanyangadadiperusahaan']; ?>" /></td>
        </tr>
        <tr>
