                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
                                    $id = $_GET['id'];
                                    $query = mysql_query("select * from datacurriculumvitae where curriculum_id='$id'");
                                    $no = 1;
                                    ...
                                    ?>
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                    $query9 = mysql_query("select * from datadokumen where curriculum_id='$id'");
                                    $data9 = mysql_fetch_array($query9);
                                        ?>
                                        <tr>
                                            <td>Dokumen Lamaran</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=/calonpekerja/".$data9['link_dokumenlamaran'].">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Dokumen Ijazah</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=/calonpekerja/".$data9['link_dokumenijazah'].">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Dokumen Skill Pendukung</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=/calonpekerja/".$data9['link_dokumenskillpendukung'].">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Foto</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=/calonpekerja/".$data9['link_dokumenfoto'].">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                 ...
                                 <form name="update_data" action="updatestatuslamaran.php" method="post">
                                <input type="hidden" name="curriculum_id" value="<?php echo $id; ?>" />
                                <br></br>
                               <center>Keputusan Lamaran : 
                                <input type="radio" name="statuslamaran" value="tidak diterima" checked="1"/> Tidak Diterima
                                <input type="radio" name="statuslamaran" value="diterima"/> Diterima</center>
                                <center><input type="submit" name="submit" value="Simpan" /></center></form>
                          </div>
