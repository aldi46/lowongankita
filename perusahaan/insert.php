...
$query = mysql_query("insert into dataperusahaan values('', '$usernameperusahaan', '$password', '$namaperusahaan', '$emailperusahaan', '$noteleponperusahaan', '$alamatperusahaan', '$deskripsiperusahaan', '$jenispekerjaanyangadadiperusahaan')") or die(mysql_error());
