        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <?php echo "Selamat datang ", $_SESSION['usernameperusahaan'];?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="deskripsi">
                <p>Silahkan cari pekerja yang dibututuhkan oleh perusahan dengan cara mendaftarkan lowongan perusahaan anda diwebsite kami.<p> 
