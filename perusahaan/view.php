...
echo "<tr><p><td>Username </td> <td> : </td><td>".$data['usernameperusahaan']."</td></p></tr>";
echo "<tr><p><td>Nama Perusahaan </td> <td> : </td><td>".$data['namaperusahaan']."</td></p></tr>";
echo "<tr><p><td>Email Perusahaan </td> <td> : </td><td>".$data['emailperusahaan']."</td></p></tr>";
echo "<tr><p><td>No Telepon Perusahaan </td> <td> : </td><td>".$data['noteleponperusahaan']."</td></p></tr>";
echo "<tr><p><td>Alamat Perusahaan </td> <td> : </td><td>".$data['alamatperusahaan']."</td></p></tr>";
echo "<tr><p><td>Deskripsi Perusahaan </td> <td> : </td><td>".$data['deskripsiperusahaan']."</td></p></tr>";
echo "<tr><p><td>Jenis Pekerjaan yang ada diPerusahaan </td> <td> : </td><td>".$data['jenispekerjaanyangadadiperusahaan']."</td></p></tr>";
...
<div id="login1">
                    ...
                    <ul>
                    <li><a href="edit.php?id=<?php echo $data['perusahaan_id']; ?>">Edit</a></li></ul>
