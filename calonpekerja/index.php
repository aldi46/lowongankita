        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                     <?php echo "Selamat Datang ", $_SESSION['usernamecalonpekerja']; ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="deskripsi">
                <p>Silahkan mendaftarkan lamaran pekerjaan anda di lowongan - lowongan yang ada di website kami, salam sukses.<p> 
