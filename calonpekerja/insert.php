...
$query = mysql_query("insert into datacalonpekerja values('', '$usernamecalonpekerja', '$password', '$namacalonpekerja', '$kotacalonpekerja', '$provinsicalonpekerja', '$alamatcalonpekerja', '$emailcalonpekerja', '$noteleponcalonpekerja', '$pendidikanterakhir', '$skilldankeahlian')") or die(mysql_error());
