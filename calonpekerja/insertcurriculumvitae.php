...
if ($query) {
	...
	$query2 = mysql_query("select * from datacalonpekerja,datacurriculumvitae where datacalonpekerja.calonpekerja_id=datacurriculumvitae.calonpekerja_id and usernamecalonpekerja='$usernamecalonpekerja' and lowongan_id='$id'");
	$data2 = mysql_fetch_array($query2);
	$a = $data2['curriculum_id'];
	header("location:inputlamaran.php?id=$a");
}
?>