                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $data9 = mysql_fetch_array($query9);
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><?php echo "<a href=\"".$data9['link_dokumenlamaran']."\">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Dokumen Ijazah</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=\"".$data9['link_dokumenijazah']."\">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Dokumen Skill Pendukung</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=\"".$data9['link_dokumenskillpendukung']."\">Download</a>"; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Foto</td>
                                            <td>:</td>
                                            <td><?php echo "<a href=\"".$data9['link_dokumenfoto']."\">Download</a>"; ?></td>
                                        </tr>
                                        <?php $no++; } ?>
                                    </tbody>
                                </table>
