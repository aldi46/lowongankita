                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <?php 
                                $id = $_GET['id'];
                                $query = mysql_query("select * from posting where posting_id='$id'") or die(mysql_error());
                                $data = mysql_fetch_array($query);
                                ?>
                                    <form role="form" name="update_data" action="update-posting.php" method="post">
                                        <input type="hidden" name="posting_id" value="<?php echo $id; ?>">
                                        <div class="form-group">
                                            <label>TglPost</label>
                                            <input type="text" name="TglPost" required="required" value="<?php echo $data['TglPost']; ?>" class="form-control" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Judul</label>
                                            <input type="text" name="Judul" required="required" value="<?php echo $data['Judul']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Isi</label>
                                            <textarea type="text" name="Isi" required="required" class="form-control"><?php echo $data['Isi']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Nav</label>
                                            <input type="text" name="Nav" required="required" value="<?php echo $data['Nav']; ?>" class="form-control" disabled>
                                        </div>
